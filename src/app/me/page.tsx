      ...
      <section className="grid gap-6 lg:grid-cols-[360px_minmax(0,1fr)]">
        <SectionCard className="rounded-[2rem] p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-[var(--muted)]">My Page</p>
          ...
          <div className="mt-6 grid gap-4">
            <div className="rounded-2xl border border-white/10 bg-black/10 p-4">
              <p className="text-xs uppercase tracking-[0.2em] text-[var(--muted)]">내 질문</p>
            ...
            <div className="rounded-2xl border border-white/10 bg-black/10 p-4">
              <p className="text-xs uppercase tracking-[0.2em] text-[var(--muted)]">최근 수정</p>
        ...
        <div className="grid gap-6">
          <QuestionList
            title="내가 쓴 질문"
            description="내가 중심에 남긴 질문들"
            questions={pageData.myQuestions}
            emptyMessage="아직 남긴 질문이 없다."
          />

          <SectionCard className="rounded-[2rem] p-6">
            <div className="mb-4 flex items-center gap-2">
              <NotebookPen className="h-5 w-5 text-[var(--accent)]" />
              <h2 className="display-font text-2xl font-semibold text-white">내가 쓴 사유</h2>
            </div>
