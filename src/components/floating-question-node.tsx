...
import { formatDate, summarizeText, cn } from "@/lib/utils";
  ...
  return (
    ...
    >
      ...
      <div className={cn("pt-10", compact && "pt-8")}>
        <p className={cn("display-font text-[2rem] leading-tight text-[#d2c4b3]", compact && "text-[1.55rem]")}>
          {question.title}
        </p>
        <p className="mt-3 max-w-[26ch] text-sm leading-7 text-[var(--muted)]">
          {summarizeText(question.description || "설명이 비어 있는 질문이다.", compact ? 92 : 118)}
        </p>
